	...
	public static function typedjs_shortcode( $atts, $content = null ) {
		...
		ob_start(); ?>
			...
			var <?php echo esc_attr( $instance_id ); ?> = new Typed('#<?php echo esc_attr( $instance_id ); ?>', {
				strings: <?php echo json_encode( array_map( 'esc_attr', $strings ) ); ?>,
				typeSpeed: <?php echo esc_attr( (int) $atts['typespeed'] ); ?>,
				backSpeed: <?php echo esc_attr( (int) $atts['backspeed'] ); ?>,
				backDelay: <?php echo esc_attr( (int) $atts['backdelay'] ); ?>,
				startDelay: <?php echo esc_attr( (int) $atts['startdelay'] ); ?>,
				loop: <?php echo esc_attr( 'true' === $atts['loop'] ? 'true' : 'false' ); ?>,
				loopCount: <?php echo esc_attr( (int) $atts['loopcount'] ); ?>,
				fadeOut: <?php echo esc_attr( 'true' === $atts['fadeout'] ? 'true' : 'false' ); ?>,
				fadeOutDelay: <?php echo esc_attr( (int) $atts['fadeoutdelay'] ); ?>,
				smartBackspace: <?php echo esc_attr( 'true' === $atts['smartbackspace'] ? 'true' : 'false' ); ?>,
				shuffle: <?php echo esc_attr( 'true' === $atts['shuffle'] ? 'true' : 'false' ); ?>,
				showCursor: <?php echo esc_attr( 'true' === $atts['showcursor'] ? 'true' : 'false' ); ?>,
